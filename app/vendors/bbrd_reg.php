 ...
 * 
 * And actually, it'll register the agents for all the sites which's about from BBR, like "bbrd" or sth. like that.
 */
...
while ($r = mysql_fetch_assoc($rs)) {
	...
	curl_setopt($ch, CURLOPT_URL, "http://bigbucksrevenue.com/_scripts/update-chan/addchan.php?a=support@paydirtdollars.com&channel=$agname&code=$agname");
